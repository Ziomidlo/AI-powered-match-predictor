...
for match in finished_matches:
   ...
   current_home_possition = structured_team_standings[home_team]["Position"]
   current_away_possition = structured_team_standings[away_team]["Position"]
...
team_venue_dict = venue_mapping.set_index('Home')['Venue'].to_dict()
merged_matches['Venue'] = merged_matches['Venue'].fillna(merged_matches['Home'].map(team_venue_dict))
missing_venues = {"Ipswich Town FC" : "Portman Road"}
merged_matches['Venue'] = merged_matches["Venue"].fillna(merged_matches['Home'].map(missing_venues))
...
upcoming_matches['Venue'] = None
upcoming_matches['Venue'] = upcoming_matches['Venue'].fillna(upcoming_matches['Home'].map(team_venue_dict))
upcoming_matches['Venue'] = upcoming_matches['Venue'].fillna(upcoming_matches['Home'].map(missing_venues))
